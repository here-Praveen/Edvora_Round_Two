...
public class Testcaseten {
	...
	public static void main(String[] args) {
      ...
      if(vall.equals(u)) {
    	  System.out.println("The User can able to navigate to the settings Page using Back Button");
      }
    	  else {
    		  System.out.println("The User was not able to navigate to the settings Page using Back Button");
    	  }
      }
